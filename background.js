export class ParallaxBackground {
    constructor(game){
        this.game = game;
        this.width = this.game.width - 600;
        ...
        this.layers = [new Layer(this.game, 0, this.layerImages[0]), new Layer(this.game, 0.4, this.layerImages[1]), new Layer(this.game, 0.8, this.layerImages[3]), new Layer(this.game, 1, this.layerImages[4]), new Layer(this.game, 0, this.layerImages[5])];
    }
